...
namespace Grand.Web.Areas.Maintenance.Controllers
{
    ...
    public class EquipmentMaster : BaseAdminController
    {
        ...
        public async Task<IActionResult> Edit(string equipmentCode)
        {
            ...
            //ViewModel Data = new ViewModel();
            //Data.SelectedJobPlan = new JobplanModel() { AssignedTo = "Vishnu", Department = "Software" };

            //Data.SelectedSparepart = new SparepartModel() {DRAWING_NO="11",PART_NUMBER="333",POSITION_NUMBER="4000",EquipmentCode="5000",EquipmentName="Vishnu"};
            // Data.SelectedEquipment = Selectedequipment;
        ...
        //public async Task<IActionResult> Edit1(string equipmentCode)
        //{
        ...
        //public async Task<IActionResult> Edit(ViewModel data)
        //{
        ...
        {
            //var EquipmentCode = HttpContext.Session.GetString("EquipmentCode").ToString();
            //var EquipmentName = HttpContext.Session.GetString("EquipmentName").ToString();
            var VesselName = HttpContext.Session.GetString("VesselName").ToString();
            //var Sub1_number = HttpContext.Session.GetString("Sub1_number").ToString();
        ...
        public async Task<IActionResult> UpdateJobPlan(DataSourceRequest command, Jobplan models)
        {
            ...
            {
                days = Convert.ToInt32(models.Frequency) * 30;
            }
            else if (models.FrequencyType.ToLower() == "week")
            {
                days = Convert.ToInt32(models.Frequency) * 7;
            }
